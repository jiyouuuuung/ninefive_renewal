	...
	<div class="container">
        ...
        <div class="contents work_detail en">
			...
			<div class="feature intro">
				<div class="txt">
					<h3 class="title">IGOBAEYA – CONTRACTION TIMER</h3>
					<p class="desc">Among many Contraction Timer apps out there, it’s hard to find a decent app that preganant women can use easily with good quality. This is where we started. Let’s make a good Contraction Timer app that works perfectly and is even beautiful. We named it ‘iGoBaeya’ meaning ‘Ah! My stomach hurts!’ in Korean with slightly witty tone. We tried to design UI as friendly and simple as possible to relief the tension that women would feel at the contraction moment.</p>
				</div>
			</div>

			<div class="feature f01">
				<div class="img_wrap web">
                    <img src="/images/work/img_work_detail_visual_w-5.jpg" alt=""/>
                </div>
                <div class="img_wrap mobile">           
                    <img src="/images/work/img_work_detail_visual_m-5.jpg" alt=""/>
                </div>
                <div class="img_wrap">
					<img src="/images/work/img_work_detail_slider_w_01-5.jpg" alt=""/>
					<img src="/images/work/img_work_detail_slider_w_02-5.jpg" alt=""/>
					<img src="/images/work/img_work_detail_slider_w_03-5.jpg"  alt=""/>
					<img src="/images/work/img_work_detail_slider_w_04-4.jpg"  alt=""/>
				</div>	
			</div>
            <div class="movie" id="movie">
				<div class="movie_wrap">
					<a href="#" class="btn_vimeo_play"></a>  
					<iframe id="vimeo_player" src="https://player.vimeo.com/video/125866079?color=65d50c&title=0&byline=0&portrait=0&quality=720p&player_id=vimeo_player" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>            
				</div>
			</div>

			<div class="project_info">
				<div class="img_wrap">
					<img src="/images/work/img_work_detail_halfvisual_w-5.jpg" alt=""/>
				</div>
				<div class="info_wrap">
					<div class="valign">
						<div class="middle">
							<ul>
								...
								<li>
                                    ...
                                    Project Manager : Jungwoong Shin<br />
                                    UX Planner : Moonsoo Kim<br />
                                    Art Director : Suwoong Byun<br />
                                ...
                                <!-- <li class="launch_site">
                                    <a href="http://www.exynos.com/" target="_blank">Launch the Site</a>
                                </li> -->
							</ul>						
						</div>
					</div>
