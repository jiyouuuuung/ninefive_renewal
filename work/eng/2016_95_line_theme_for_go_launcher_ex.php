	...
	<div class="container">
        ...
        <div class="contents work_detail en">
			...
			<div class="feature intro">
				<div class="txt">
					<h3 class="title">95 LINE THEME FOR GO LAUNCHER EX</h3>
					<p class="desc">It has a minimal and line style design based on NINEFIVE's identity. Simple line icons on black background with 'effort green' point color. If you have been looking for a simple and sophisticated style, 95 Line Theme could be your choice. Please enjoy it and make your phone more stylish! 95 Line Theme needs GO Launcher EX installed and is only for Android phone.</p>
				</div>
			</div>

			<div class="feature f01">
				<div class="img_wrap web">
					<img src="/images/work/LINE_THEME_intro-1.jpg" alt=""/>
					<img src="/images/work/02detail_01-2.jpg" alt=""/>
					<img src="/images/work/02detail_02-1.jpg" alt=""/>
					<img src="/images/work/02detail_03-1.jpg"  alt=""/>
				</div>	
                <div class="img_wrap mobile">
                    <img src="/images/work/LINE_THEME_intro-1_m.jpg" alt=""/>
                    <img src="/images/work/02detail_01.jpg" alt=""/>
                    <img src="/images/work/02detail_02.jpg" alt=""/>
                    <img src="/images/work/02detail_03.jpg" alt=""/>
                </div>
			</div>

			<div class="project_info">
				<div class="img_wrap">
					<img src="/images/work/03info.jpg" alt=""/>
				</div>
				<div class="info_wrap">
					<div class="valign">
						<div class="middle">
							<ul>
								<li>
                                    ...
                                    Designer: Suwoong Byun, Yujin Kwon<br />
